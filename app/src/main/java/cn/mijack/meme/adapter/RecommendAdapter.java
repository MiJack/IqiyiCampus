...
import cn.mijack.meme.model.BaseEntity;
...
import cn.mijack.meme.utils.UiUtils;
import cn.mijack.meme.view.CycleBanner;
...
public class RecommendAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class NewsViewHolder extends BaseViewHolder implements View.OnClickListener{
        ...
        private void setItemData(View itemVew, ImageView cover, TextView name, TextView snsScore, TextView playCount, VideoInfo video) {
            ...
            Glide.clear(cover); //清除缓存
            Glide.with(itemVew.getContext()).load(ImageUtils.getRegImage(video.img, ImageUtils.IMG_480_270)).animate(R.anim.alpha_on).into(cover);
        }
