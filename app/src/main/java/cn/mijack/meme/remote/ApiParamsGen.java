...
import cn.mijack.meme.utils.ApiConstant;
import cn.mijack.meme.utils.DeviceUtils;
...
public class ApiParamsGen {
     ...
     * @return
     */
    public static Map<String, String> genCommonParams(Context context) {
        ...
        params.put("net_sts", NetWorkTypeUtils.getNetWorkType(context));
        params.put("scrn_sts", "0"); //屏幕状态，0：默认， 1：竖屏， 2：横屏，3：mini
        params.put("scrn_res", DeviceUtils.getResolution(context)); //屏幕分辨率
        params.put("scrn_dpi", String.valueOf(DeviceUtils.getScreenDensityDpi(context))); //屏幕密度
        params.put("qyid", DeviceUtils.getDeviceId(context));
     ...
     * @param context
     */
    public static Map<String, String> genChannelParams(Context context) {
        Map<String, String> params = genCommonParams(context);
     ...
     * @return
     */
    public static Map<String, String> genChannelDetailParams(Context context, String channelId, String channelName, int pageIndex, int pageSize) {
        Map<String, String> params = genCommonParams(context);
     ...
     * @return
     */
    public static Map<String, String> genRecommendDetailParams(Context context, int pageIndex, int pageSize) {
        Map<String, String> params = genCommonParams(context);
        params.put("page_num", String.valueOf(pageIndex));
        params.put("page_size", String.valueOf(pageSize));
        return params;
